...
// Automated testing checks Java_com_myrustlib_MyRustLibModule and myrustlib
...
Java_com_myrustlib_MyRustLibModule_nativeInstallRustCrate(
    JNIEnv *env,
    jclass type,
    jlong rtPtr,
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_myrustlib_MyRustLibModule_nativeCleanupRustCrate(JNIEnv *env, jclass type, jlong rtPtr) {
    auto runtime = reinterpret_cast<jsi::Runtime *>(rtPtr);
